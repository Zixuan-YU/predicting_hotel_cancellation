...
### Python Analysis:
We first do some more exploratory data analysis and visualized the distributions of key variables. We found that number of weekend days in the canceled reservations have a wider distribution. We fit four distinct models: Support Vector Machine (Radial), Random Forest, Logistic Regression and Gradient Boosting.  
